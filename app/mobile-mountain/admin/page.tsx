                    ...
                    {filteredBookings.map((booking) => (
                      <div key={booking.id} className="border border-gray-200 rounded-lg p-4">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                          <div>
                            <h4 className="font-medium text-gray-900 mb-2">{booking.name}</h4>
                          ...
                          <div>
                            <p className="text-sm font-medium text-gray-900 mb-2">{booking.service}</p>
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center space-x-2">
                              <select
                                ...
                                onChange={(e) => updateBookingStatus(booking.id, e.target.value as 'Pending' | 'Confirmed' | 'Cancelled')}
