...
function ServicesSection() {
  const services = [
    {
      ...
      price: "$75",
      description: "Complete exterior wash, clay bar treatment, and wax application",
      features: [
        "Hand wash and dry",
        "Clay bar treatment",
        "Wax application",
  ...
  const addOns = [
    {
      title: "Clay Bar + Wax",
      price: "+$25",
      description: "Deep paint decontamination and protection"
    },
    {
  ...
  const vehicleSurcharges = [
    ...
    { type: "SUV", surcharge: "+$50" },
    { type: "Truck", surcharge: "+$50" }
  ];
  ...
  return (
    <section className="section-padding bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Add-ons Section */}
        <div className="mb-16">
          <h3 className="text-2xl font-bold text-gray-900 text-center mb-8">Add-on Services</h3>
        ...
        {/* Vehicle Surcharges */}
        <div>
          <h3 className="text-2xl font-bold text-gray-900 text-center mb-8">Vehicle Type Surcharges</h3>
              ...
              <div className="grid grid-cols-2 gap-4">
                {vehicleSurcharges.map((vehicle, index) => (
                  <div key={index} className="flex justify-between items-center py-2 border-b border-gray-100 last:border-b-0">
                    ...
                    <span className="text-primary-600 font-semibold">{vehicle.surcharge}</span>
                  </div>
                ))}
              </div>
            </div>
